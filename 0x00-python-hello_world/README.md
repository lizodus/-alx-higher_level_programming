...
- [2-print.py](2-print.py) :  prints exactly "Programming  is like building a multilingual puzzle, followed by a new line.
...
- [100-write.py](100-write.py) :  prints exactly ```and that piece of art is useful - Dora Korpar, 2015-10-19,``` followed by a new line.
